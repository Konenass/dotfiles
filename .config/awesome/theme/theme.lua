...
theme.wallpaper                                 = theme.dir .. "/wallpapers/coffe_bridge.png"

-- fonts
local theme_font_type                       = "Iosevka Mono"
local theme_font_size                       = "10"
local hotkeys_font_type                     = "Iosevka Mono Bold"
...
local taglist_buttons = require("buttons.taglist-buttons")
local tasklist_buttons = require("buttons.tasklist-buttons")
